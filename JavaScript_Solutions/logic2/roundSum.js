/**
 * Returns the sum of three parameters that are rounded up to the nearest 10 if the rightmost digit of the parameter is 5 or greater, and rounded down otherwise.
 * 
...
/**
 * Returns a rounded number, rounds up if rightmost digit is greater than 5, rounds down otherwise.
 * 
