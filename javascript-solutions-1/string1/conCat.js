/**
 * Returns a concatenated string from 2 parameter strings. If the last character of str1 and the first character of str2 match, then the first character of str2 will be omitted.
 * 
