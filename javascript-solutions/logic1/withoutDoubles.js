/**
 * Returns the sum of two dice. However, if noDoubles is true and the dice show the same number, increment one die to the next value, wrapping around to 1 if its value was 6.
 * 
