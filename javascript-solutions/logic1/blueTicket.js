/**
 * Returns 10 if two parameters equal 10, returns 5 if the sum of num1 and num2 is exactly 10 more than the sum of num2 and num3 or num1 and num3. Returns 0 otherwise.
 * 
