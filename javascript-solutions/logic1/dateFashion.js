/**
 * Returns 2 if either of the parameters is greater than or equal to 8 and neither parameter is less than or equal to 2, in which case function returns 0. Otherwise, returns 1.
 * 
