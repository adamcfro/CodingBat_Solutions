/**
 * Returns the sum of three parameters while checking that they aren't 
 * teen numbers (except for 15 and 16).
 * 
...
/**
 * Helper function that returns 0 if number parameter is in the teens, unless 
 * it equals 15, 16, or any non-teen number, in which case it returns 
 * the original parameter number.
 * 
