/**
 * A simple alarm clock function that displays what time we should wake up. 
 * Returns 'off' if it is a weekend and we are on vacation. Returns 10 if 
 * it is the weekend and we are not on vacation. Returns 7 otherwise.
 * 
