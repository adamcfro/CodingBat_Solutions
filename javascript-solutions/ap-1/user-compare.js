 ...
 * Return -1 if A comes before B, 1 if A comes after B, and 0 if they 
 * are the same. Order first by the string names, and then by the id numbers 
 ...
 * @returns {Number} - Returns a number corresponding to proper sorting order
 */
