/**
 * Helper function that hecks if a number is between 13 and 19 and returns true if so.
 * 
 ...
 * @returns {Boolean}       Returns true if one of the parameters is in the range 13-19
 */
